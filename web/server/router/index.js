...
// REPORT ROUTES
router.post("/reports/importExcel", reportController.importExcel);
...
router.put("/reports/:reportId/categories/:categoryId", categoryController.updateCategory);
router.delete("/reports/:reportId/categories/:categoryId", categoryController.deleteCategory);
router.get("/categories", categoryController.getAllCategories);
router.get("/categories/:id", categoryController.getCategoryById);
router.get("/categories/reportType/:reportTypeId", categoryController.getCategoriesByReportType);
router.get("/categories/name/:name", categoryController.getCategoryByName);
// SUBCATEGORY ROUTES
// router.post("/reports/:reportId/categories/:categoryId/subcategories", categoryController.addSubCategory);
// router.put("/reports/:reportId/categories/:categoryId/subcategories/:subCategoryId", categoryController.updateSubCategory);
// router.delete("/reports/:reportId/categories/:categoryId/subcategories/:subCategoryId", categoryController.deleteSubCategory);
...
router.put("/company/:id", multer.single("profilePicture"), companyController.updateCompany);
